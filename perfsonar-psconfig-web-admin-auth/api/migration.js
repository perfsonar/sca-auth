...
var migrations = [
    ...
    */
    ...
    function (qi, next) {
        ...
        qi.addColumn("Users", "email_confirmed", {
    ...
    function (qi, next) {
        ...
        qi.addColumn("Users", "email_confirmation_token", {
            type: Sequelize.STRING /*defaultValue: uuid.v4()*/,
        }).then(function () {
            next();
        });
    },
    function (qi, next) {
        ...
        qi.addColumn("Users", "fullname", { type: Sequelize.STRING }).then(
            function () {
                next();
            }
        );
    ...
    function (qi, next) {
        ...
        qi.addColumn("Users", "ldap", { type: Sequelize.STRING }).then(
            function () {
                next();
            }
        );
    ...
    function (qi, next) {
        ...
        qi.addColumn("Users", "github", { type: Sequelize.STRING }).then(
            function () {
                next();
            }
        );
    ...
    function (qi, next) {
        ...
        qi.addColumn("Users", "facebook", { type: Sequelize.STRING }).then(
            function () {
                next();
            }
        );
    ...
    function (qi, next) {
        ...
        qi.addColumn("Users", "password_reset_cookie", {
    ...
    function (qi, next) {
        ...
        qi.addColumn("Users", "orcid", { type: Sequelize.STRING }).then(
            function () {
                next();
            }
        );
    ...
    return new Promise(function (resolve, reject) {
        db.Migration.findOne({}).then(function (info) {
            ...
            if (!info) {
                ...
                return db.Migration.create({ version: migrations.length }).then(
                    resolve
                );
            } else {
